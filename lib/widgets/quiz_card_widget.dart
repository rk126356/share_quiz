          ...
          Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    const Icon(CupertinoIcons.eye, color: Colors.blue),
                    const SizedBox(width: 8),
                    Text(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    const Icon(CupertinoIcons.play_arrow, color: Colors.blue),
                    const SizedBox(width: 8),
                    Text(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    const Icon(CupertinoIcons.heart, color: Colors.blue),
                    const SizedBox(width: 8),
                    Text(
